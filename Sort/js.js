...
const videos = [
    {
      ...
      thumbnail: "../Sort TextFile/images/thumbnail_82.png",
      uploadDate: new Date(2021, 6, 5),
      viewCount: 300,
    },
    {
      title: "Episode 85 - JSON (Part 2)",
      thumbnail: "../Sort TextFile/images/thumbnail_85.png",
      uploadDate: new Date(2021, 6, 8),
      viewCount: 1000,
    },
    {
      title: "Episode 84 - JSON (Part 1)",
      thumbnail: "../Sort TextFile/images/thumbnail_84.png",
      uploadDate: new Date(2021, 6, 7),
      viewCount: 200,
    },
    {
      title: "Episode 83 - localStorage (Part 2)",
      thumbnail: "../Sort TextFile/images/thumbnail_83.png",
  ...
  videos.forEach((video) =>{
    const videoTag = `<div class="videoContainer">
